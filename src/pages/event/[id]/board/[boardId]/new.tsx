  ...
  return (
    ...
    >
      <div className="flex flex-1 flex-col">
        ...
        <div
          className="absolute bottom-[60px] flex flex-row w-screen h-[144px] px-[20px] items-center overflow-y-auto overflow-x-auto overscroll-x-contain scrollbar-hide">
          {images.map((image) => (
            <div
              key={image}
